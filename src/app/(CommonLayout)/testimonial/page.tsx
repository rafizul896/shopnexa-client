  ...
  const featuredTestimonials = [
    {
      ...
      content: "The quality exceeded my expectations! The dress fits perfectly and the fabric feels luxurious. Delivery was super fast too. I'll definitely be ordering again.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Outstanding customer service and product quality. The team went above and beyond to ensure my order was perfect. This is how e-commerce should be done.",
      rating: 5,
    ...
    },
    {
      ...
      company: "Local Cafe",
      content: "I've been a customer for over 2 years now. Consistently high quality products, fair prices, and excellent support. They truly care about their customers.",
      rating: 5,
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Experience the quality and service that our customers rave about. Start shopping today!
          </p>
